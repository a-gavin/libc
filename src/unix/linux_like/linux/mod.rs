...
// linux/nl80211.h
// TODO: Kept everything except #defines that redefine an existing enum
//       imo no sense keeping #defines if we're not using the CPP
...
pub const NL80211_CMD_UNSPECIFIED: c_int = 0;
...
pub const __NL80211_ATTR_AFTER_LAST: c_int = 337;
...
pub const NL80211_NUM_AC: c_int = 4;
