...
// Changes to nl80211 come through the Linux wireless trees available here:
// https://web.git.kernel.org/pub/scm/linux/kernel/git/wireless/wireless-next.git/
// https://web.git.kernel.org/pub/scm/linux/kernel/git/wireless/wireless.git/
...
pub const NL80211_EDMG_BW_CONFIG_MIN: c_int = 4;
pub const NL80211_EDMG_BW_CONFIG_MAX: c_int = 15;
pub const NL80211_EDMG_CHANNELS_MIN: c_int = 1;
pub const NL80211_EDMG_CHANNELS_MAX: c_int = 0x3c;
...
// There's a NL80211_AUTHTYPE_AUTOMATIC, but it is only used
// internally within the kernel
